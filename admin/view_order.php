                ...
                <head>
                    ...
                    function popUpWindow(URLStr, left, top, width, height) {
                        ...
                        popUpWin = open(URLStr, 'popUpWin',
                            ...
                            1000 + ',height=' + 1000 + ',left=' + left + ', top=' + top + ',screenX=' + left +
                            ',screenY=' + top + '');
                    }
                    </script>
                </head>
                ...
                <body class="fix-header fix-sidebar">
                                                                ...
                                                                <td>
                                                                    <center>
                                                                        <a href="javascript:void(0);"
                                                                            ...
                                                                            title="Update order">
                                                                            <button type="button"
                                                                                class="btn btn-primary">Update Order
                                                                                Status</button></a>
                                                                    </center>
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <center>
                                                                        <a href="javascript:void(0);"
                                                                            ...
                                                                            title="Update order">
                                                                            <button type="button"
                                                                                class="btn btn-primary">View User
                                                                                Detials</button></a>
                    ...
                    <footer class="footer"> © 2023 - Online Food Delivery</footer>
