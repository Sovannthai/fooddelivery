        ...
        <div id="main-wrapper">
            ...
            <div class="page-wrapper">
                ...
                <div style="padding-top: 10px;">
                    <div style="padding-top: 10px;">
                        <marquee onMouseOver="this.stop()" onMouseOut="this.start()"> <a href="#">Group 4 <a href="#">Assigment
                                    Webdynamic Content</a></marquee>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="card p-30">
                                            <div class="media">
                                                <div class="media-left meida media-middle">
                                                    <span><i class="fa fa-th-large f-s-40" aria-hidden="true">All</i></span>
                                                </div>
                                                <div class="media-body media-text-right">
